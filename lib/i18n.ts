...
export const translations = {
  en: {
    ...
    profil_steal_owner: 'STEAL FROM @{owner} — {price} T',
    profil_steal_noowner: 'BUY — {price} T',
  ...
  fr: {
    ...
    profil_steal_owner: 'VOLER À @{owner} — {price} T',
    profil_steal_noowner: 'ACHETER — {price} T',
