...
export const translations = {
  en: {
    ...
    profil_steal_noowner: 'STEAL — {price} J',
    ...
    activity_tab_everyone: 'EVERYONE', activity_tab_friends: 'FRIENDS',
  ...
  fr: {
    ...
    activity_tab_everyone: 'TOUT LE MONDE', activity_tab_friends: 'AMIS',
